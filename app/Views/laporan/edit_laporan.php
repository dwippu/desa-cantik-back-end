...
<?= $this->Section('content'); ?>
    <div class="container-fluid">
        ...
        <div class="card-body">
            ...
            <div class="card">
            <div class="card-body">
                <form action="/editlaporan/<?= $laporan['id'] ?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-6">
                    ...
                    <div class="mb-3 pt-2">
                        ...
                        <input id="nama_kegiatan" name="nama_kegiatan" type="text" class="form-control <?php  if (session('validation')){if (array_key_exists("nama_kegiatan", session('validation'))) {echo 'is-invalid';};};?>" value="<?php if($laporan){echo $laporan['nama_kegiatan'];}else{echo old('nama_kegiatan');};?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="peserta_kegiatan" name="peserta_kegiatan" type="text" class="form-control <?php  if (session('validation')){if (array_key_exists("peserta_kegiatan", session('validation'))) {echo 'is-invalid';};};?>" value="<?php if($laporan){echo $laporan['peserta_kegiatan'];}else{echo old('peserta_kegiatan');};?>">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input id="tanggal_kegiatan" name="tanggal_kegiatan" type="date" class="form-control <?php  if (session('validation')){if (array_key_exists("tanggal_kegiatan", session('validation'))) {echo 'is-invalid';};};?>" value="<?php if($laporan){echo $laporan['tanggal_kegiatan'];}else{echo old('tanggal_kegiatan');};?>">
                        ...
                        <input name="laporanLama" type="hidden" value="<?= $laporan['file']?>">
                    </div><br>
                    <button type="submit" class="btn btn-primary">Submit</button><br><br>
                    <label class="form-label">Preview Laporan</label>
                    <embed src="../Laporan/<?= $laporan['file']?>" id="file_view" type="application/pdf" width="100%" height="600px" style="border-style: solid;"></embed>
