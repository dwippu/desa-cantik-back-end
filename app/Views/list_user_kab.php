  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="col">
        <div class="collapse multi-collapse pass-collapse">
          <div class="card card-body p-4">
            <form action="/cobapost" method="post" class="d-inline" id="form-reset-user">
              <label for="old-password" class="mb-2">Masukkan Password Anda</label>  
              <input type="password" name="old-password" class="form-control" placeholder="password" required>
              <label for="new-password" class="mb-2">Masukkan Password baru untuk akun ini</label>  
              <input type="password" name="new-password" class="form-control" placeholder="password baru" required>
              <label for="confirm-password" class="mb-2">Ketik Ulang Password</label>  
